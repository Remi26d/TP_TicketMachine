...
public class TicketMachine {
	...
	/**
	 * Refunds the balance to the customer and resets the balance to zero.
	 *
	...
	public int refund() {
		...
		balance = 0;
		System.out.println("Je vous rends : " + refundedAmount + " centimes");
		return refundedAmount;
	}

	/**
	 * Print a ticket. Update the total collected and reduce the balance
	 * if there is enough balance to cover the ticket price.
	 *
	...
	public boolean printTicket() {
		if ( balance >= price ) {
			...
			// not enough balance to print a ticket
			return false;
		}
	}
}